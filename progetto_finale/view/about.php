<!-- BB Ceramics, sito di e-commerce per pezzi di ceramica artigianale
     ...
     Pagina di biografia/contatti dell'artista -->
...
<body>
    ...
    <div id="formWrap">
        <h2>Contattami via mail qua:</h2>
            <dl>
                <dt>Oggetto:</dt>
                <dd><input type="text" required></dd>
                <dt>Messaggio:</dt>
                <dd><textarea required></textarea></dd>
                <dt></dt>
                <dd><input type="submit" name="submit" value="Invia"></dd>
            </dl>
    </div>
